  ...
  return (
    <SheetPrimitive.Backdrop
      ...
      className={cn(
        ...
        "fixed inset-0 z-50 bg-[#111318]/24 transition-opacity duration-(--dur-base) ease-(--ease-out-soft) data-ending-style:opacity-0 data-starting-style:opacity-0",
        className,
      )}
      {...props}
    />
