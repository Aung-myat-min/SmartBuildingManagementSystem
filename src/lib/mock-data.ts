...
export const EQUIPMENT_TYPES: EquipmentTypeDef[] = [
  ...
  { id: "air-conditioner", label: "Air conditioner", controls: "hvac" },
  ...
  { id: "air-handling-unit", label: "Air handling unit", controls: "hvac" },
...
export const EQUIPMENT_UNITS: EquipmentUnit[] = [
  ...
  },
  {
    ...
    hvac: { mode: "off", setpointC: 22, fan: 2 },
    condition: "healthy",
...
export const SENSOR_TYPES: SensorTypeDef[] = [
  // HVAC. These read a number, so their statuses are chosen by bands rather
  // than set by hand — see lib/sensor-readings.ts. Everything downstream is
  // unchanged: a band produces a status id and nothing more.
  {
    id: "temperature",
    label: "Temperature",
    icon: "thermometer",
  ...
  },
  {
    ...
    icon: "droplet",
    statuses: [
      { id: "dry", label: "Dry", tone: "warning", isAlarm: false },
      {
        id: "comfortable",
        label: "Comfortable",
        tone: "success",
      ...
      { id: "humid", label: "Humid", tone: "warning", isAlarm: false },
      {
        id: "condensation",
    ...
    measurement: {
      ...
      decimals: 0,
      bands: [
        { upTo: 30, statusId: "dry" },
        { upTo: 60, statusId: "comfortable" },
        { upTo: 75, statusId: "humid" },
        { upTo: null, statusId: "condensation" },
      ],
    },
  },
  {
    ...
    statuses: [
      ...
      { id: "poor", label: "Poor ventilation", tone: "danger", isAlarm: true },
    ],
    actions: [],
    measurement: {
      unit: "ppm",
...
export const SENSORS: EnvironmentalSensor[] = [
  // HVAC. These carry a reading; their status comes from the type's bands.
  {
    id: "TMP-216-302",
    buildingId: "b216",
    roomId: "r-216-302",
